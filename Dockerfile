...
RUN dotnet build "MediaLibrary.WebUI.csproj" -c $BUILD_CONFIGURAION -o /app/build

FROM build AS publish
RUN dotnet publish "MediaLibrary.WebUI.csproj" -c $BUILD_CONFIGURAION -o /app/publish /p:UseAppHost=false
